...
export declare class AttachmentFieldDefinitionService extends BaseFieldDefinitionService {
    dataType: string;
    constructor(injector: Injector);
    getFieldInspectorConfig(options: IFieldOptions): IFormBuilderConfig;
    static ɵfac: i0.ɵɵFactoryDeclaration<AttachmentFieldDefinitionService, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<AttachmentFieldDefinitionService>;
}
