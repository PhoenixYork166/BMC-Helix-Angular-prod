...
export declare class RxAttachmentFieldDefinitionService extends RxBaseFieldDefinitionService {
    resourceType: string;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<RxAttachmentFieldDefinitionService, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<RxAttachmentFieldDefinitionService>;
}
