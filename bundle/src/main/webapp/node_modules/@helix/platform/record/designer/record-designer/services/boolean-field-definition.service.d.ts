...
export declare class RxBooleanFieldDefinitionService extends RxBaseFieldDefinitionService {
    resourceType: string;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<RxBooleanFieldDefinitionService, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<RxBooleanFieldDefinitionService>;
}
