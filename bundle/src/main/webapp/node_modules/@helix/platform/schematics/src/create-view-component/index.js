...
function default_1(schema) {
    return (tree) => {
        ...
        const rxBundleInfo = new bundle_info_1.RxBundleInfo(bundlePackage);
        schema.bundleId = rxBundleInfo.bundleId;
        schema.libraryName = rxBundleInfo.libraryName;
        schema.bundleFriendlyName = rxBundleInfo.bundleFriendlyName;
        ...
        return schematics_1.chain([
            ...
            utils_1.insertImportToLibraryModule(rxBundleInfo.libraryModulePath, strings_1.classify(schema.viewComponentName) + 'RegistrationModule', './view-components/' +
