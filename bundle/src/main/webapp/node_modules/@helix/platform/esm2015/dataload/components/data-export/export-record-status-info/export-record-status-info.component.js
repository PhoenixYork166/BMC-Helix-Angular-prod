    ...
    constructor(datePipe, rxTranslateService, rxJsonParserService, activeModalRef, rxRecordInstanceDataPageService) {
        ...
        this.statusData$ = this.rxRecordInstanceDataPageService
            ...
            if (dataExportProgressStatus) {
                return _map(dataExportProgressStatus, (statusInfo) => (Object.assign(Object.assign({}, statusInfo), { updateTime: this.datePipe.transform(statusInfo.updateTime, 'medium') })));
            }
            else {
...
ExportRecordStatusInfoComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.1.3", ngImport: i0, type: ExportRecordStatusInfoComponent, deps: [{ token: i1.DatePipe }, { token: i2.TranslateService }, { token: i3.RxJsonParserService }, { token: i4.ActiveModalRef }, { token: i5.RxRecordInstanceDataPageService }], target: i0.ɵɵFactoryTarget.Component });
...
//# sourceMappingURL=export-record-status-info.component.js.map