...
const update_lib_config_1 = require("../update-lib-config");
function updateWorkspace() {
    return schematics_1.chain([
        utils_1.cleanUp('shell'),
        utils_1.cleanUp('styles'),
        utils_1.cleanUp('scripts'),
        utils_1.copy('shell'),
        utils_1.copy('styles'),
        utils_1.copy('scripts'),
        ...
        update_lib_config_1.updateLibConfig(),
