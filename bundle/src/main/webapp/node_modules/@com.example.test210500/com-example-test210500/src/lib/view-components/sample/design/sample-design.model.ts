...
import { ISampleParameters } from './sample.interface';

// View component input parameters.
const initialComponentProperties: ISampleParameters = {
  styles: '',
  hidden: '',
  message: ''
};

export class SampleDesignModel extends ViewDesignerComponentModel implements IViewDesignerComponentModel {
  constructor(protected injector: Injector,
    ...
    combineLatest([this.sandbox.componentProperties$])
      .pipe(
        map(([componentProperties]: [ISampleParameters]) =>
  ...
  static getInitialProperties(initialProperties?: ISampleParameters): ISampleParameters {
  ...
  private setInspectorConfig(model : ISampleParameters) {
    return {
