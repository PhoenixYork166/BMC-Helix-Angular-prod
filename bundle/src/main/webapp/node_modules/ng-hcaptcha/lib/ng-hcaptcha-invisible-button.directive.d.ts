...
export declare class NgHcaptchaInvisibleButtonDirective implements OnInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgHcaptchaInvisibleButtonDirective, "[ngHcaptchaInvisibleButton]", never, { "siteKey": "siteKey"; "languageCode": "languageCode"; }, { "verify": "verify"; "expired": "expired"; "error": "error"; "click": "click"; }, never>;
}
