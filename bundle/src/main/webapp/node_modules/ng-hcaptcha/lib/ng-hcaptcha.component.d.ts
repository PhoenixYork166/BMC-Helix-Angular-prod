...
export declare class NgHcaptchaComponent implements OnInit, OnDestroy, ControlValueAccessor {
    ...
    onChange: any;
    onTouched: any;
    constructor(config: CaptchaConfig, zone: NgZone, platformId: any);
    ngOnInit(): void;
    ngOnDestroy(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NgHcaptchaComponent, "ng-hcaptcha", never, { "siteKey": "siteKey"; "theme": "theme"; "size": "size"; "tabIndex": "tabIndex"; "languageCode": "languageCode"; }, { "verify": "verify"; "expired": "expired"; "error": "error"; }, never, never>;
}
