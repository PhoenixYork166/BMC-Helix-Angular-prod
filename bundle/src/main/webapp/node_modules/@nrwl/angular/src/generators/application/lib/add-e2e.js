 ...
 */
function addE2e(host, options, e2eProjectRoot) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        if (options.e2eTestRunner === "protractor" /* Protractor */) {
            yield add_protractor_1.addProtractor(host, options);
        }
        else {
            remove_scaffolded_e2e_1.removeScaffoldedE2e(host, options, e2eProjectRoot);
        }
        if (options.e2eTestRunner === 'cypress') {
            yield cypress_1.cypressProjectGenerator(host, {
        ...
        if (options.e2eTestRunner === "protractor" /* Protractor */) {
            update_e2e_project_1.updateE2eProject(host, options);
            if (options.standaloneConfig) {
                workspace_1.convertToNxProjectGenerator(host, {
