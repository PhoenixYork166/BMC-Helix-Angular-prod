/*! Rappid v3.1.1 - HTML5 Diagramming Framework
...
export class Vectorizer {
  ...
  static annotateString(
    t: string,
    annotations: Vectorizer.TextAnnotation[],
    opt?: Vectorizer.AnnotateStringOptions
  ...
  static findAnnotationsBetweenIndexes(
    annotations: Vectorizer.TextAnnotation[],
    start: number,
    end: number
  ): Vectorizer.TextAnnotation[];

  static shiftAnnotations(
    annotations: Vectorizer.TextAnnotation[],
    index: number,
    offset: number
  ): Vectorizer.TextAnnotation[];
...
export namespace dia {
  ...
  type OrthogonalDirection = 'left' | 'top' | 'right' | 'bottom';

  type Direction = OrthogonalDirection | 'top-left' | 'top-right' | 'bottom-right' | 'bottom-left';

  type LinkEnd = 'source' | 'target';

  interface MarkupNodeJSON {
    tagName: string;
    selector?: string;
  ...
  class Graph extends Backbone.Model {
    ...
    dfs(
      element: Element,
      iteratee: (element: Element, distance: number) => boolean,
      opt?: Graph.ConnectionOptions
    ): void;
  ...
  class LinkView extends CellViewGeneric<Link> {
    ...
    sendToken(
      token: SVGElement,
      opt?: { duration?: number; direction?: string; connection?: string },
      callback?: () => void
    ): void;
  ...
  export namespace Paper {
    ...
    interface Options extends mvc.ViewOptions<Graph> {
      ...
      interactive?:
        | ((cellView: CellView, event: string) => boolean | CellView.InteractivityOptions)
        | boolean
        | CellView.InteractivityOptions;
      ...
      defaultConnectionPoint?:
        | connectionPoints.ConnectionPointJSON
        | connectionPoints.ConnectionPoint
        | ((...args: any[]) => connectionPoints.ConnectionPoint);
      // connecting
  ...
  class Paper extends mvc.View<Graph> {
    ...
    checkViewport(opt?: { mountBatchSize?: number; unmountBatchSize?: number; viewport?: Paper.ViewportCallback }): {
      mounted: number;
      unmounted: number;
    };

    updateViews(opt?: { batchSize?: number; viewport?: Paper.ViewportCallback; progress?: Paper.ProgressCallback }): {
      updated: number;
      batches: number;
    };
    ...
    protected updateViewsBatch(opt?: { batchSize?: number; viewport?: Paper.ViewportCallback }): Paper.UpdateStats;
    ...
    protected onCellHighlight(
      cellView: CellView,
      magnetEl: SVGElement,
      opt?: { highlighter?: highlighters.HighlighterJSON }
    ): void;
...
export namespace shapes {
  namespace standard {
    ...
    class Rectangle extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<RectangleSelectors>, opt?: dia.Graph.Options);
    }
    ...
    class Circle extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<CircleSelectors>, opt?: dia.Graph.Options);
    }
    ...
    class Ellipse extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<EllipseSelectors>, opt?: dia.Graph.Options);
    }
    ...
    class Path extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<PathSelectors>, opt?: dia.Graph.Options);
    }
    ...
    class Polygon extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<PolygonSelectors>, opt?: dia.Graph.Options);
    }
    ...
    class Polyline extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<PolylineSelectors>, opt?: dia.Graph.Options);
    }
    ...
    class Image extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<ImageSelectors>, opt?: dia.Graph.Options);
    }
    ...
    class BorderedImage extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<BorderedImageSelectors>, opt?: dia.Graph.Options);
    }
    ...
    class EmbeddedImage extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<EmbeddedImageSelectors>, opt?: dia.Graph.Options);
    }
    ...
    class InscribedImage extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<InscribedImageSelectors>, opt?: dia.Graph.Options);
    }
    ...
    class HeaderedRectangle extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<HeaderedRectangleSelectors>, opt?: dia.Graph.Options);
    }
    ...
    class Cylinder extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<CylinderSelectors>, opt?: dia.Graph.Options);
    ...
    class TextBlock extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<TextBlockSelectors>, opt?: dia.Graph.Options);
    }
    ...
    class Link extends dia.Link {
      constructor(attributes?: dia.Link.GenericAttributes<LinkSelectors>, opt?: dia.Graph.Options);
    }
    ...
    class DoubleLink extends dia.Link {
      constructor(attributes?: dia.Link.GenericAttributes<DoubleLinkSelectors>, opt?: dia.Graph.Options);
    }
    ...
    class ShadowLink extends dia.Link {
      constructor(attributes?: dia.Link.GenericAttributes<ShadowLinkSelectors>, opt?: dia.Graph.Options);
    }
  }
  ...
  namespace basic {
    ...
    class Rect extends Generic {
      constructor(attributes?: dia.Element.GenericAttributes<RectSelectors>, opt?: { [key: string]: any });
    }

    interface CircleSelectors extends SVGTextSelector, SVGCircleSelector {}

    class Circle extends Generic {
      constructor(attributes?: dia.Element.GenericAttributes<CircleSelectors>, opt?: { [key: string]: any });
    }

    interface EllipseSelectors extends SVGTextSelector, SVGEllipseSelector {}

    class Ellipse extends Generic {
      constructor(attributes?: dia.Element.GenericAttributes<EllipseSelectors>, opt?: { [key: string]: any });
    }

    interface PolygonSelectors extends SVGTextSelector, SVGPolygonSelector {}

    class Polygon extends Generic {
      constructor(attributes?: dia.Element.GenericAttributes<PolygonSelectors>, opt?: { [key: string]: any });
    }

    interface PolylineSelectors extends SVGTextSelector, SVGPolylineSelector {}

    class Polyline extends Generic {
      constructor(attributes?: dia.Element.GenericAttributes<PolylineSelectors>, opt?: { [key: string]: any });
    }

    interface ImageSelectors extends SVGTextSelector, SVGImageSelector {}

    class Image extends Generic {
      constructor(attributes?: dia.Element.GenericAttributes<ImageSelectors>, opt?: { [key: string]: any });
    }

    interface PathSelectors extends SVGTextSelector, SVGPathSelector {}

    class Path extends Generic {
      constructor(attributes?: dia.Element.GenericAttributes<PathSelectors>, opt?: { [key: string]: any });
    }
    ...
    class TextBlock extends Generic {
      constructor(attributes?: dia.Element.GenericAttributes<TextBlockSelectors>, opt?: { [key: string]: any });
    }
  }
  ...
  namespace erd {
    ...
    class Entity extends basic.Generic {
      constructor(attributes?: dia.Element.GenericAttributes<PolygonalSelectors>, opt?: { [key: string]: any });
    }
    ...
    class Attribute extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<EllipsoidSelectors>, opt?: { [key: string]: any });
    }
    ...
    class ISA extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<basic.PolygonSelectors>, opt?: { [key: string]: any });
    }
  ...
  namespace fsa {
    ...
    class EndState extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<CirculoidSelectors>, opt?: { [key: string]: any });
    }
  ...
  namespace logic {
    ...
    class IO extends Gate {
      constructor(attributes?: dia.Element.GenericAttributes<basic.CircleSelectors>, opt?: { [key: string]: any });
    }
    ...
    class Gate11 extends Gate {
      constructor(attributes?: dia.Element.GenericAttributes<Gate11Selectors>, opt?: { [key: string]: any });
    }
    ...
    class Gate21 extends Gate {
      constructor(attributes?: dia.Element.GenericAttributes<Gate21Selectors>, opt?: { [key: string]: any });
    }
  ...
  namespace org {
    ...
    class Member extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<MemberSelectors>, opt?: { [key: string]: any });
    }
  ...
  namespace uml {
    ...
    class State extends basic.Generic {
      constructor(attributes?: dia.Element.GenericAttributes<StateSelectors>, opt?: { [key: string]: any });
    ...
    class EndState extends basic.Generic {
      constructor(attributes?: dia.Element.GenericAttributes<EndStateSelectors>, opt?: { [key: string]: any });
    }
...
export namespace util {
  ...
  export function setAttributesBySelector(
    el: Element,
    attrs: { [selector: string]: { [attribute: string]: any } }
  ): void;
  ...
  namespace format {
    ...
    export function prefix(
      value: number,
      precision: number
    ): { scale: (d: number) => number; symbol: string } | undefined;
  }
  ...
  export function merge(
    ...
    sourceObject1: object,
    sourceObject2: object,
  ...
  export function merge(
    ...
    sourceObject2: object,
    sourceObject3: object,
    sourceObject4: object,
    customizer?: CustomizerFunction
  ): object;
  // generic but less precise signature for `merge`
  export function merge(
    destinationObject: object,
    ...sourceObjectsOptionalFinalCustomizer: SourceObjectsOptionalFinalCustomizer
  ): object;
...
export namespace routers {
  ...
  type GenericRouter<K extends RouterType> = (
    vertices: dia.Point[],
...
export namespace connectors {
  ...
  type GenericConnector<K extends ConnectorType> = (
...
export namespace anchors {
  ...
  type GenericAnchor<K extends AnchorType> = (
...
export namespace connectionPoints {
  ...
  type GenericConnectionPoint<K extends ConnectionPointType> = (
...
export namespace ui {
  class Clipboard extends Backbone.Collection<Backbone.Model> {
     ...
     */
    copyElements(
      selection: Backbone.Collection<dia.Cell>,
      graph: dia.Graph,
      opt?: { [key: string]: any }
    ): Array<dia.Cell>;
  ...
  class Snaplines extends mvc.View<undefined> {
    ...
    protected show(opt?: { vertical?: number; horizontal?: number }): void;
  ...
  namespace TreeLayoutView {
    export interface Options extends mvc.ViewOptions<layout.TreeLayout> {
      ...
      validateConnection?:
        | ((element: dia.Element, candidate: dia.Element, treeLayoutView: TreeLayoutView) => boolean)
        | null;
      translateElements?:
        | ((
        ...
        | null;
      reconnectElements?:
        | ((elements: dia.Element[], x: number, y: number, treeLayoutView: TreeLayoutView) => void)
        | null;
      paperConstructor?: typeof dia.Paper;
      paperOptions?: dia.Paper.Options;
      [key: string]: any;
...
export namespace format {
  ...
  export namespace gexf {
    export function toCellsArray(
      xmlString: string,
      makeElement: (opt: getx.ElementOptions) => dia.Element,
      makeLink: (opt: getx.LinkOptions) => dia.Link
    ): Array<dia.Cell>;
  }
  ...
  export function toPNG(
    ...
    opt?: dia.Paper.RasterExportOptions
  ): void;
...
export namespace layout {
  ...
  namespace TreeLayout {
    ...
    export interface Options {
      ...
      updateAttributes?:
        | null
        | ((layoutArea: any, root: dia.Element, rootLink: dia.Link, opt: { [key: string]: any }) => void);
      filter?:
        | null
...
export namespace shapes {
  export namespace standard {
    ...
    class Record extends dia.Element {
      constructor(attributes?: Record.Attributes<Record.Selectors>, opt?: dia.Graph.Options);
      ...
      addItemAtIndex(
        id: Record.ItemId | Record.GroupId,
        index: number,
        item: Record.Item,
    ...
    class BorderedRecord extends Record {
      constructor(attributes?: Record.Attributes<BorderedRecord.Selectors>, opt?: dia.Graph.Options);
    }
    ...
    class HeaderedRecord extends Record {
      constructor(attributes?: Record.Attributes<HeaderedRecord.Selectors>, opt?: dia.Graph.Options);
    }
  ...
  export namespace chart {
    ...
    class Plot extends shapes.basic.Generic {
      ...
      constructor(attributes?: Plot.Attributes, opt?: { [key: string]: any });
    ...
    class Matrix extends shapes.basic.Generic {
      ...
      constructor(attributes?: Matrix.Attributes, opt?: { [key: string]: any });
    }
  ...
  export namespace bpmn {
    ...
    namespace Activity {
      interface Selectors
        extends shapes.SVGTextSelector,
          shapes.SVGRectSelector,
          shapes.SVGPathSelector,
          shapes.SVGImageSelector {
        '.body'?: attributes.SVGRectAttributes;
    ...
    class Activity extends shapes.basic.TextBlock {
      ...
      constructor(attributes?: Activity.Attributes, opt?: { [key: string]: any });
    ...
    class Annotation extends shapes.basic.TextBlock {
      constructor(attributes?: Annotation.Attributes, opt?: { [key: string]: any });
    ...
    class Gateway extends dia.Element {
      icon: string;
      constructor(attributes?: Gateway.Attributes, opt?: { [key: string]: any });
    ...
    class Event extends dia.Element {
      icon: string;
      constructor(attributes?: Event.Attributes, opt?: { [key: string]: any });
    ...
    class Pool extends dia.Element {
      constructor(attributes?: Pool.Attributes, opt?: { [key: string]: any });
    }
    ...
    class Group extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<Group.Selectors>, opt?: { [key: string]: any });
    }
    ...
    class DataObject extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<DataObject.Selectors>, opt?: { [key: string]: any });
    }
    ...
    class Conversation extends dia.Element {
      subProcess: boolean;
      constructor(attributes?: Conversation.Attributes, opt?: { [key: string]: any });
    ...
    class Choreography extends shapes.basic.TextBlock {
      subProcess: boolean;
      constructor(attributes?: Choreography.Attributes, opt?: { [key: string]: any });
    ...
    class Message extends dia.Element {
      constructor(attributes?: dia.Element.GenericAttributes<Message.Selectors>, opt?: { [key: string]: any });
    }
    ...
    class Flow extends dia.Link {
      constructor(attributes?: Flow.Attributes, opt?: { [key: string]: any });
