...
import { IDigitalSignatureEffectsParameters } from './digital-signature-effects.interface';

const initialComponentProperties: IDigitalSignatureEffectsParameters = {};

export class DigitalSignatureEffectsDesignModel extends ViewDesignerComponentModel implements IViewDesignerComponentModel<IDigitalSignatureEffectsParameters> {
...
// export class DigitalSignatureEffectsDesignModel extends ViewDesignerComponentModel implements IViewDesignerComponentModel {
//   constructor(protected injector: Injector,
//               protected sandbox: IViewComponentDesignSandbox) {
//     super(injector, sandbox);
...
//       .pipe(
//         map(([componentProperties]: [IDigitalSignatureEffectsParameters]) =>
...
//   static getInitialProperties(initialProperties?: IDigitalSignatureEffectsParameters): IDigitalSignatureEffectsParameters {
...
//   private setInspectorConfig(model : IDigitalSignatureEffectsParameters) {
//     return {
//       inspectorSectionConfigs: [
//         {
//           label: 'General',
...
//     model: IDigitalSignatureEffectsParameters
