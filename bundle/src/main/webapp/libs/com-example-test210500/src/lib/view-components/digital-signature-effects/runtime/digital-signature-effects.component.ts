...
import { IDigitalSignatureEffectsParameters } from '../design/digital-signature-effects.interface';
...
@Component({
  selector: 'com-example-test210500-digital-signature-effects',
  styleUrls: ['./digital-signature-effects.scss'],
  templateUrl: './digital-signature-effects.component.html'
})
@RxViewComponent({
  name: 'com-example-test210500-digital-signature-effects',
})
export class DigitalSignatureEffectsComponent extends BaseViewComponent implements OnInit,IViewComponent {
  ...
  inputParams: IDigitalSignatureEffectsParameters;
  ...
  ngOnInit() {
    ...
    this.config.subscribe((config: IDigitalSignatureEffectsParameters) => {
